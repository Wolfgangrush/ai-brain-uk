...
class EntityRegistry:
    ...
    Stored at ~/.ailawfirm-uk/entity_registry.json
    Schema:
    {
    ...
    DEFAULT_PATH = Path.home() / ".ailawfirm-uk" / "entity_registry.json"
    ...
    def learn_from_text(self, text: str, min_confidence: float = 0.75) -> list:
        ...
        """
        from ailawfirm_uk.entity_detector import extract_candidates, score_entity, classify_entity
