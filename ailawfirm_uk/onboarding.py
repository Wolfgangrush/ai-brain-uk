...
Usage:
    python3 -m ailawfirm_uk.onboarding
    or: brain init
"""

from pathlib import Path
from ailawfirm_uk.entity_registry import EntityRegistry
from ailawfirm_uk.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from ailawfirm_uk.entity_registry import COMMON_ENGLISH_WORDS
...
def _generate_alias_bootstrap(
    ...
    """
    brain_dir = Path(config_dir) if config_dir else Path.home() / ".ailawfirm-uk"
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.ailawfirm-uk/alias_entities.md")
    print("  Critical facts bootstrap: ~/.ailawfirm-uk/critical_facts.md")
