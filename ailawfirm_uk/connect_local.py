...
Usage from CLI:
    ...
    ailawfirm-uk connect-local --yes      # skip prompts
    ailawfirm-uk connect-local --model qwen3:7b   # force a specific model

Result: ~/.ailawfirm-uk/config.json is written with ai_provider=ollama and the
...
def install_ollama_instructions() -> None:
    ...
    print()
    print("Then run `ailawfirm-uk connect-local` again.")
...
def cmd_connect_local(args) -> int:
    ...
    print("  ailawfirm-uk connect-cloud --provider deepseek --cloud-warning-acknowledged")
    print()
    return 0
