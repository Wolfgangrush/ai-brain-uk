"""ailawfirm_uk.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`ailawfirm_uk.brain.router.think` function. The user types a
...
from ailawfirm_uk.brain.router import think
...
_BANNER = (
    "ailawfirm_uk brain — terminal front door\n"
