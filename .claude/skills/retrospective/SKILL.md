---
name: retrospective
description: End-of-session save discipline for UK AI Brain users. Runs 2-pass leak-check (Rule 6: no internal-shorthand, no internal-paths, no personal-build references). Saves session learning so the firm gets smarter with every use.
allowed-tools: Bash, Read, Glob
---

# /retrospective — End-of-Session Save Discipline (UK)

Saves what the UK AI Brain learned this session. Runs at session end. The firm accumulates knowledge across sessions without leaking personal context.
...
- What legal domains were touched (civil procedure under CPR, crime, family, chancery, King's Bench, SRA compliance, BSB regulation, UK GDPR, REUL, commercial, property, immigration, employment)
- What courts or jurisdictions were referenced (UK Supreme Court, EWCA, High Court, Court of Session (Scotland), High Court of Justiciary (Scotland), County Court, Magistrates' Court, tribunals)
- Any errors or blockers encountered

### Step 2: Run 2-pass leak-check (above)

### Step 3: If passes leak-check, write session summary
Save to `.ailawfirm-uk/sessions/` with timestamp. Format:
```markdown
...
## Output Format
```markdown
## /retrospective — UK AI Brain · Session Save
