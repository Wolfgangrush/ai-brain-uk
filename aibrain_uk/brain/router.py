...
# Routing map
# ---------------------------------------------------------------------------
# Each Intent value maps to the module name in aibrain_uk/agents/ that
...
def _call_agent(agent_module_name: str, payload: str) -> Dict[str, Any]:
    ...
    running.
    """
    full_module = f"aibrain_uk.agents.{agent_module_name}"
    try:
...
def think(text: str) -> Dict[str, Any]:
    ...
    from aibrain_uk.brain import specialists
