"""aibrain_uk.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`aibrain_uk.brain.router.think` function. The user types a
...
from aibrain_uk.brain.router import think
...
_BANNER = (
    "aibrain_uk brain — terminal front door\n"
