...
Usage:
    python3 -m aibrain_uk.onboarding
    or: brain init
"""

from pathlib import Path
from aibrain_uk.entity_registry import EntityRegistry
from aibrain_uk.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from aibrain_uk.entity_registry import COMMON_ENGLISH_WORDS
...
def _generate_alias_bootstrap(
    ...
    """
    brain_dir = Path(config_dir) if config_dir else Path.home() / ".aibrain-uk"
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.aibrain-uk/alias_entities.md")
    print("  Critical facts bootstrap: ~/.aibrain-uk/critical_facts.md")
