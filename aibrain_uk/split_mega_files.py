...
# Loaded from ~/.aibrain-uk/known_names.json if it exists, otherwise generic fallback.
_KNOWN_NAMES_PATH = HOME / ".aibrain-uk" / "known_names.json"
...
def _load_known_people() -> list:
    ...
    if _KNOWN_NAMES_PATH.exists():
        try:
            ...
            pass
    # Generic fallback — override by creating ~/.aibrain-uk/known_names.json
...
def extract_people(lines):
    ...
    if dir_match:
        ...
        # User can map usernames to names in ~/.aibrain-uk/known_names.json
