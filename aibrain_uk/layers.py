...
Reads directly from ChromaDB (aibrain_uk_drawers)
and ~/.aibrain-uk/identity.txt.
"""
...
class Layer0:
    ...
    Reads from ~/.aibrain-uk/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.aibrain-uk/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 — IDENTITY\nNo identity configured. Create ~/.aibrain-uk/identity.txt"
            )
...
class Layer3:
    ...
    Reuses searcher.py logic against aibrain_uk_drawers.
    """
...
class MemoryStack:
    ...
    def __init__(self, palace_path: str = None, identity_path: str = None):
        cfg = BrainConfig()
        self.palace_path = palace_path or cfg.palace_path
        self.identity_path = identity_path or os.path.expanduser("~/.aibrain-uk/identity.txt")
