...
> This file was generated by `aibrain-uk init`. It tells the AI (Claude / Gemini / DeepSeek / local model) how this firm works. Edit it as your practice evolves — your edits survive `aibrain-uk update`.
...
This runs `pip install --upgrade git+https://github.com/Wolfgangrush/ai-brain-uk.git` under the hood. Your matter data is NEVER touched — only firm code/skills/prompts get refreshed.
...
Add your own rules below. They survive `aibrain-uk update`.
