...
class EntityRegistry:
    ...
    Stored at ~/.aibrain-uk/entity_registry.json
    Schema:
    {
    ...
    DEFAULT_PATH = Path.home() / ".aibrain-uk" / "entity_registry.json"
    ...
    def learn_from_text(self, text: str, min_confidence: float = 0.75) -> list:
        ...
        """
        from aibrain_uk.entity_detector import extract_candidates, score_entity, classify_entity
