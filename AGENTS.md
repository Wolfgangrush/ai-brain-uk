...
```bash
python3 -m aibrain_uk reception   # greet + systems-check + memory + recap
python3 -m aibrain_uk ask "<q>"   # route one query through the brain
python3 -m aibrain_uk chat        # interactive REPL
python3 -m aibrain_uk recap       # show retrospective-memory recap
```
